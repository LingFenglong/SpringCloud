...
public class OrderController {
    ...
    public OrderController(@Qualifier("com.lingfenglong.springcloud.service.PaymentService") PaymentService paymentService) {
...
//            fallback = "getByIdFallback",
    ...
    public String getById(@PathVariable("id") Long id) {
        String res = paymentService.paymentSQL(id);
